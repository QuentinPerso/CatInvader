...
public class TimeCalc {
	...
	private final static int TIME2LIFE=1800, //second
	                         MAXMAKI=42, MAKIPERTIME=7;
	private boolean lifeupdate = false;
	public  boolean makiupdate = false;
	...
	/////////////////////////////////////// time elapsed from last save
		...
		if(Save.gd.maki<MAXMAKI){
			if((Save.gd.maki+MAKIPERTIME*(timeelapsfromsave/TIME2LIFE))<=MAXMAKI) {
				Save.gd.maki+=MAKIPERTIME*(timeelapsfromsave/TIME2LIFE);
			}
			else{
				Save.gd.maki=MAXMAKI;
			}
		}
